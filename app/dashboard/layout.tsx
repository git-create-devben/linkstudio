    ...
    <UserProvider user={user}>
      <div className="h-screen flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-hidden relative">
          ...
          <div className="w-full h-full overflow-y-auto bg-[center_55px_/var(--glass-background)] bg-no-repeat bg-gradient-to-br from-purple-50 via-white to-blue-50 backdrop-blur-xl border border-white/[0.06] shadow-2xl">
            <MobileNotice />
            <div className="p-2">
              {children}
            </div>
